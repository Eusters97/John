...
export default function FrontPageLayout({ children }: FrontPageLayoutProps) {
  ...
  const handleQuickInvest = (plan: string, amount: number, expectedReturn: number, roi: string) => {
    if (!user) {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-gray-50 via-white to-forex-50">
      {/* Sidebar */}
      <div className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-2xl transform transition-transform lg:translate-x-0 lg:static lg:inset-0 border-r border-gray-200`}>
        ...
        <div className="mt-8 px-4">
          <div className="bg-gradient-to-r from-forex-50 to-blue-50 rounded-lg p-4">
            ...
            <div className="space-y-2">
              <Button 
                onClick={() => handleQuickInvest("Starter Plan", 100, 2500, "2,500%")}
                size="sm" 
              ...
              <Button 
                onClick={() => handleQuickInvest("Premium Plan", 1000, 4000, "400%")}
                size="sm" 
                variant="outline" 
        ...
        <div className="absolute bottom-8 left-4 right-4">
          <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg p-4 text-center">
            ...
            <h4 className="text-white font-semibold text-sm mb-2">Join Free Signals</h4>
