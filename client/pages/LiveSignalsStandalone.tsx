          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center text-white">
              <div className="flex items-center justify-center mb-6">
                ...
                <div>
                  <h1 className="text-2xl md:text-4xl font-bold">Live Forex Signals</h1>
            ...
            <Tabs defaultValue="live" className="w-full">
              ...
              <TabsContent value="live" className="space-y-6">
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-600 max-w-2xl mx-auto">
                    Follow our live signals for real-time trading opportunities with professional analysis and risk management.
                  </p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                  {liveSignals.map((signal) => (
                    <Card key={signal.id} className="border-2 border-gray-100 hover:border-forex-200 transition-all duration-200 hover:shadow-lg">
                        ...
                        <div className="flex justify-between items-center">
                          <div className="flex items-center space-x-3">
                            <Badge
                              ...
                              className={`${
                                signal.action === "BUY" ? "bg-success-500" : "bg-danger-500"
                      ...
                      <CardContent className="space-y-3">
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          ...
                          <div>
                            ...
                            <div className="font-semibold text-danger-600">{signal.stopLoss}</div>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          ...
                          <div>
                            ...
                            <div className="font-semibold text-success-600">{signal.pips}</div>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          <div>
                            ...
                            <div className={`font-semibold ${
                              signal.confidence === 'Very High' ? 'text-success-600' :
                              signal.confidence === 'High' ? 'text-blue-600' : 'text-yellow-600'
                            }`}>
                              {signal.confidence}
                            </div>
                          </div>
                          <div>
                            ...
                            <div className={`font-semibold ${
                              signal.risk === 'Low' ? 'text-success-600' :
                              signal.risk === 'Medium' ? 'text-yellow-600' : 'text-danger-600'
                            }`}>
                              {signal.risk}
                            </div>
                          </div>
              ...
              <TabsContent value="completed" className="space-y-6">
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-600 max-w-2xl mx-auto">
                    Track record of our recent completed signals showing consistent profitability.
                  </p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                  {completedSignals.map((signal) => (
                    <Card key={signal.id} className="border-2 border-success-100 hover:border-success-200 transition-all duration-200 hover:shadow-lg">
                      <CardHeader className="pb-3">
                        <div className="flex justify-between items-center">
                          <div className="flex items-center space-x-3">
                      ...
                      <CardContent className="space-y-3">
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          ...
                          <div>
                            ...
                            <div className="font-semibold text-success-600">{signal.exit}</div>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          ...
                          <div>
                            ...
                            <div className="font-semibold text-success-600">{signal.profit}</div>
                          </div>
                        </div>

                        <div className="pt-2 border-t">
                          <div className="flex items-center justify-between">
                            <span className="text-xs text-gray-500">Duration: {signal.duration}</span>
                            <span className="text-xs text-gray-500 flex items-center">
                              <Clock className="h-3 w-3 mr-1" />
                              {signal.time}
                            </span>
              ...
              <Card className="bg-gradient-to-r from-forex-50 to-blue-50 border-forex-200">
                <CardContent className="p-8">
                  ...
                  <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                    Get all these signals delivered directly to your Telegram. Join 3,400+ traders already profiting from our signals.
                  </p>
                  <a
